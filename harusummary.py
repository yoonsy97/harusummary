...
target_email = ["4_night@naver.com","lilyyoon2000@gmail.com"] # 대상 이메일
target_keyword = ["삼성전자","SK하이닉스","한국금융지주"] # 대상 기업 keyword 
...
write_Kakao_message('afd')
keyword = input('검색할 키워드를 입력하세요(,로 파싱 가능 ): ')
defalut_keyword  = ['삼성전자']

if not keyword :
    print("keyword is null")
    keyword = defalut_keyword
else : keyword=parse_string_to_list(keyword)
